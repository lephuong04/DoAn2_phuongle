...
WebUI.click(findTestObject('Object Repository/Page_NetTruyen  c Truyn Tranh Online Min Ph_c6bf41/a_ng k'))

WebUI.setText(findTestObject('Object Repository/Page_NetTruyen Chnh Thc - c Truyn Tranh Online/input_Name_name'), 'huy')

WebUI.setText(findTestObject('Object Repository/Page_NetTruyen Chnh Thc - c Truyn Tranh Online/input_Email_email'), 'phuong89hy@gmail.com')
